      ...
      <div className="max-w-4xl mx-auto pb-20">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-500 dark:text-gray-400 max-w-2xl mx-auto">
            Tu compañero personal de entrenamiento. Aquí tienes una guía rápida de todo lo que
            puedes hacer para alcanzar tus objetivos.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white dark:bg-[#1a2632] border border-gray-200 dark:border-[#233648] rounded-2xl p-6 hover:shadow-lg transition-all">
            ...
            <p className="text-gray-500 dark:text-gray-400 mb-4">
              Crea y organiza tus propias rutinas de entrenamiento. Selecciona ejercicios de nuestra
              biblioteca, define series, repeticiones y pesos.
            </p>
            <Link to="/routine" className="text-primary font-bold hover:underline">
              Ir a Rutinas →
            </Link>
          </div>
          ...
          <div className="bg-white dark:bg-[#1a2632] border border-gray-200 dark:border-[#233648] rounded-2xl p-6 hover:shadow-lg transition-all">
            ...
            <p className="text-gray-500 dark:text-gray-400 mb-4">
              Lleva el seguimiento en tiempo real. Cronómetro de descanso automático, registro de
              series completadas y ajuste de pesos sobre la marcha.
            </p>
            <Link to="/routine" className="text-primary font-bold hover:underline">
              Empezar ahora →
            </Link>
          ...
          <div className="bg-white dark:bg-[#1a2632] border border-gray-200 dark:border-[#233648] rounded-2xl p-6 hover:shadow-lg transition-all">
            ...
            <p className="text-gray-500 dark:text-gray-400 mb-4">
              Visualiza tu evolución. Gráficos de volumen de carga, frecuencia de entrenamientos y
              mejoras en tus levantamientos clave.
            </p>
          ...
          <div className="bg-white dark:bg-[#1a2632] border border-gray-200 dark:border-[#233648] rounded-2xl p-6 hover:shadow-lg transition-all">
            ...
            <p className="text-gray-500 dark:text-gray-400 mb-4">
              Supera tus marcas y recibe notificaciones cuando logres un nuevo récord personal en
          ...
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-gray-300">
                Ve a la sección de <strong>Rutinas</strong> y crea tu primera rutina personalizada
                con el botón "+ Nueva Rutina". ¡Es el primer paso para transformar tu cuerpo!
              </p>
            </div>
            <Link
              to="/routine/new"

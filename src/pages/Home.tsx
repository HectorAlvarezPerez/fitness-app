    ...
    <div className="h-full w-full overflow-y-auto p-4 md:p-8">
      <div className="flex flex-col max-w-4xl mx-auto flex-1 gap-6 pb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Link
            to="/routine"
            className="group relative overflow-hidden rounded-2xl bg-white dark:bg-[#1a2632] border border-slate-200 dark:border-[#233648] p-6 hover:border-primary/50 transition-colors"
          >
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Inicia una nueva sesión desde tus planes.
            </p>
          </Link>
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  {lastWorkout.total_volume
                    ? `${(lastWorkout.total_volume / 1000).toFixed(1)}k kg`
                    : '0 kg'}{' '}
                  • {lastWorkout.duration_minutes || 0} min
                </p>
              </div>
            </div>

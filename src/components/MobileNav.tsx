...
const MobileNav: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="relative flex items-center justify-around px-2 pt-2 pb-safe-area-inset-bottom"
              ...
              >
                <span
                  className={`material-symbols-outlined text-[24px] transition-all duration-300 ${
                    active ? 'text-primary scale-110' : 'text-gray-500 group-hover:text-gray-400'
                  }`}
                  style={{
  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={`relative p-1.5 rounded-xl transition-all duration-300 ${
            isMoreActive || isOpen ? 'bg-primary/15' : 'group-active:bg-white/5'
          }`}
        >
          <span
            className={`material-symbols-outlined text-[24px] transition-all duration-300 ${
        ...
        <span
          className={`text-[10px] font-semibold transition-colors duration-300 ${
            isMoreActive || isOpen ? 'text-primary' : 'text-gray-500'
          }`}
        >
          Más
        </span>
      ...
      {/* Popup menu */}
      <div
        className={`absolute bottom-full right-2 mb-3 bg-[#1a1d21] border border-white/10 rounded-2xl shadow-2xl overflow-hidden transition-all duration-200 origin-bottom-right ${
          isOpen
            ...
            return (
              <NavLink
                ...
                className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all ${
                  active ? 'bg-primary/15 text-primary' : 'text-white hover:bg-white/5'
                }`}
              >
                <span
